...
//getting total items and total price of all items in the cart
...
$insert_orders="insert into user_orders (user_id,due_amount,invoice_number,total_products,order_date,order_status)
