    ...
    <div class="container-fluid m-3">
        ...
        <div class="row d-flex align-items-center justify-content-center">
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4 mt-4">
                        ...
                        placeholder="Confirm your Password" autocomplete="off" required="required" name="user_confirm_password"/>
                    </div>
                    <!-- Address field -->
                    <div class="form-outline mb-4 ">
            ...
            <div class="text-center">
                <input type="submit" value="Register" class="btn btn-info px-5 py-2 text-dark border=0" name="user_register"/>
                <p class="small fw-bold mt-2 pt-1 mb-0" >Already have an account? <a href="user_login.php" class="link-danger">Login</a></p>
            </div> 
