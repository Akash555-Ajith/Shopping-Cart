...
<div class="container mt-3">
    ...
    <form action="" method="post" class="text-center">
            <div class="form-outline mb-4">
                ...
                <input type="text" name="brand_title" id="brand_title" class="form-control border-dark w-50 m-auto" 
                required="required" value="<?php echo $brand_title?>">
            </div>
            <input type="submit" value="Update Brand" class="btn btn-info btn-outline-success px-3 mb-3 text-dark"
            name="edit_brand">
    </form>
</div>